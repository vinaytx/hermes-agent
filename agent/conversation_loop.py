...
def run_conversation(
    ...
    try:
        from agent.call_tracer import trace_event as _trace_event
        _trace_event(agent, "turn_start", user_message=original_user_message)
    except Exception:
        pass
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                try:
                    from agent.call_tracer import trace_event as _trace_event
                    _trace_event(agent, "llm_send", iteration=api_call_count, api_messages=api_messages)
                except Exception:
                    pass
                ...
                try:
                    from agent.call_tracer import trace_event as _trace_event
                    _trace_event(agent, "llm_response", iteration=api_call_count, response=response, duration=api_duration)
                except Exception:
                    pass
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                try:
                    from agent.call_tracer import trace_event as _trace_event
                    _trace_event(agent, "tool_calls", iteration=api_call_count,
                                 tool_calls=getattr(assistant_message, "tool_calls", []) or [])
                except Exception:
                    pass

                _msgs_before_tools = len(messages)
                agent._execute_tool_calls(assistant_message, messages, effective_task_id, api_call_count)

                try:
                    from agent.call_tracer import trace_event as _trace_event
                    _trace_event(agent, "tool_results", iteration=api_call_count,
                                 new_messages=messages[_msgs_before_tools:])
                except Exception:
                    pass
                ...
                try:
                    from agent.call_tracer import trace_event as _trace_event
                    _trace_event(agent, "final_response", iteration=api_call_count, response=final_response)
                except Exception:
                    pass
